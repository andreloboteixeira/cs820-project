...
\author{Mikhail~Shchukin,~\IEEEmembership{CS~820~Graduate~Student,~University~of~Regina}\IEEEauthorrefmark{1}
        ...
        and~AndrĂ©~Lobo~Texeira,~\IEEEmembership{CS~820~Graduate~Student,~University~of~Regina}\IEEEauthorrefmark{3}
        \\
Email: \IEEEauthorrefmark{1}vladimmi@uregina.ca, \IEEEauthorrefmark{2}abb549@uregina.ca, \IEEEauthorrefmark{3}ADD ANDRE EMAIL}
...
Look, here we refer to Fig. \ref{fig:img1}.
